 ...
 * 语言一变就叫一声，给不是组件的地方用。
 *
 * 现在只有一个订户：推送。收到的通知是服务端排版的，服务端不知道
 * 这台设备选了哪种语言 —— 所以切语言的时候得把新的报上去。
 *
 * 为什么不直接写在「我的」那一屏的那个按钮里：今天语言开关只有
 * 一处，明天多一处就会漏。挂在这里的话，谁改了语言都跑得到。
 */
export const onLangChange = subscribe
