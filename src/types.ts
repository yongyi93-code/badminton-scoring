...
export type Announcement = {
   ...
   * 发在哪一场球局里。
   *
   * 消息本来是发给整个球群的，摆在首页。球群开放给所有人之后那就不成立了 ——
   * 「今晚改去力天」对不去的人是噪音，而首页是每个人打开 App 第一眼看到的地方。
   *
   * 所以消息跟着球局走：在局内发，也只有这一局的人看得见。
   *
   * 可选是因为这之前发的那些没有这个字段。它们不属于任何一场球局，
   * 哪儿都不显示 —— 消息本来就是几天就过期的东西，不值得为它们做迁移。
   */
  sessionId?: string
}
